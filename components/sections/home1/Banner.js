...
export default function Banner() {
 ...
 formData.phone = phone
  ...
  const payload_email = {
    LANDING_PAGE: "Dubai Hills Estate India Landing Page",
    ORIGIN: originValue,
    COUNTRY: "India",
    NAME: formData.name,
  ...
  const payload = {
    fields: {
      TITLE: `Dubai Hills Estate India Landing Page`,
      ...
      SOURCE_ID: "WEB",
      ASSIGNED_BY_ID: 25,
      UF_CRM_1754652292782: "Dubai Hills Estate India Landing Page",
      UF_CRM_1761206533: "India",
    },
    params: {
...
IN DUBAI’S MOST SOUGH-AFTER LOCATIONS.</p>
  ...
  USD 436,000 / EUR 375,000 / GBP 324K
</p>
